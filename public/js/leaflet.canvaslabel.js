...
L.Label = L.Popup.extend({
	options: {
		...
		noHide: false,
		offset: new L.Point(0, 0) // 6 (width of the label triangle) + 6 (padding)
	},
	...
	_initLayout: function () {
		...
		canvasCtx = this._ctx = this._container.getContext('2d');

		// this._ctx.strokeStyle = '#000';
		this._ctx.fillStyle = '#FFF';
		this._ctx.font = '16px Droid Sans';
		this._ctx.fillText(this._content, 10, 16);


		canvasStyle = this._container.style;
		canvasStyle.outline = '1px solid red';
		canvasStyle.zIndex = 1000;
	},
	...
	_updateContent: function () {
		...
		if (typeof this._content === 'string') {
			...
			console.log(this._ctx, this._content);
			...
			// this._ctx.lineWidth = strokeWeight;
			// this._ctx.strokeText(text, 2, 2);

			// this._ctx.fillText(this._content, 50, 50);
